...
Canvas is an entirely open-source package that integrates smoothly into your Laravel project, enabling you to set up a blog in a matter of minutes. With a clean writing environment, you can monitor monthly content trends, get traffic insights, and much more!
...
After publishing the assets, you’ll find the main config file at config/canvas.php, which allows you to adjust various aspects of the package’s integration into your app.
...
Canvas provides three default user roles:

- **Contributor** ( Can write and manage their own posts, but cannot publish.)
- **Editor** (Can manage and publish posts, including those written by others.)
